...
void i2c_init(void)
{
    ...
    hi2c3.Init.Timing = 0x00300617;                       // 时序参数: 400kHz, 上升下降时间: 100ns
...
{
    HAL_I2C_Mem_Write(&hi2c3, AS5600_I2C_ADDR, reg, I2C_MEMADD_SIZE_8BIT, send_buffer, len, 100);
}

void i2c_read_bytes(uint16_t reg, uint8_t *recv_buffer, uint8_t len)
{
    HAL_I2C_Mem_Read(&hi2c3, AS5600_I2C_ADDR, reg, I2C_MEMADD_SIZE_8BIT, recv_buffer, len, 100);
}